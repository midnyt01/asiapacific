...
const AboutPage = () => {
    ...
    <HeroBanner/>
      <div className="container-fluid m-auto">
        ...
        <p>Asia Pacific Global Ocean Pte Ltd is a group company and India’s leading logistics service providers in the field of licensed Customs Brokerage / Customs House Agents, International Freight Forwarding and land transportation having own fleet of 20’ and 40’ trailers. Established in the year 2021, we have our own customs broker license in the name of Asia Pacific Global Ocean Pte Ltd Limited</p>
        ...
        <h3>Our Mission</h3>
        Asia Pacific Global Ocean Pte Ltd mission remains to “Deliver Service Excellence” and become the world’s preferred Clearing, Forwarding, Transportation and Sourcing company by applying insight, quality and innovation.

        <h3>Our Vision</h3>
        <p></p>To establish Asia Pacific Global Ocean Pte Ltd as the most leading Worldwide Logistics & Supply Chain Management company as a trusted partner to all our clients.
